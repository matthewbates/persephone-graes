import Antipasto from "../assets/Menu/Antipasto.png";
import Barker from "../assets/Menu/Barker.png";
import BiscuitsAndGravy from "../assets/Menu/BiscuitsAndGravy.png";
import BLTAP from "../assets/Menu/BLTAP.png";
import BreakfastBurrito from "../assets/Menu/BreakfastBurrito.png";
import BreakfastPlatter from "../assets/Menu/BreakfastPlatter.png";
import BreakfastSandwich from "../assets/Menu/BreakfastSandwich.png";
import Caesar from "../assets/Menu/Caesar.png";
import Chips from "../assets/Menu/Chips.png";
...
import GFPancakes from "../assets/Menu/GFPancakes.png";
import Gobbler from "../assets/Menu/Gobbler.png";
import GrilledMacCheese from "../assets/Menu/GrilledMacCheese.png";
import HuevosRancheros from "../assets/Menu/HuevosRancheros.png";
import Incline from "../assets/Menu/Incline.png";
import Juices from "../assets/Menu/Juices.png";
import MissPiggy from "../assets/Menu/MissPiggy.png";
import Pancakes from "../assets/Menu/Pancakes.png";
import PicnicBasket from "../assets/Menu/PicnicBasket.png";
import PigsInABasket from "../assets/Menu/PigsInABasket.png";
import RainbowFalls from "../assets/Menu/RainbowFalls.png";
import RedRock from "../assets/Menu/RedRock.png";
import Reuben from "../assets/Menu/Reuben.png";
import Ruxton from "../assets/Menu/Ruxton.png";
import SevenFalls from "../assets/Menu/SevenFalls.png";
import ShellsAndCheese from "../assets/Menu/ShellsAndCheese.png";
import Soda from "../assets/Menu/Soda.png";
import SteakAndCheese from "../assets/Menu/SteakAndCheese.png";
...
export const menu = [
  {
    ...
    desc: `2 Eggs** Any Style with Your Choice of: 3 Pieces of Bacon · 2 Sausage Patties · 2 Chorizo Patties · 1 Ham Steak | Home Fries · Hashbrowns · Seasonal Fruit | Toast · English Muffin · Biscuit · 1 Pancake`,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    category: "breakfast",
    price: "One: 3.75 | Two: 6.25 | Three: 8.50",
    img: GFPancakes,
  ...
  },
  {
    ...
    desc: "2 Eggs** Any Style on Your Choice of: Toast · English Muffin · Biscuit · 2 Small Pancakes | American · Cheddar · Swiss · Smoked Gouda · Provolone | 2 Pieces of Bacon · 1 Sausage Patty · 1 Ham Steak |  With Home Fries, Hashbrowns, Or Seasonal Fruit on the Side",
  },
  {
    id: 9,
    title: "Pig in a Basket",
    category: "breakfast",
    price: "One: 6.50 | Two: 11.50",
    img: PigsInABasket,
  ...
  },
  {
    ...
    price: 13.0,
    img: Reuben,
    desc: "1/3* lb. of Our Slow Roasted Corned Beef, Topped with Swiss, Sauerkraut, & Thousand Island Dressing Served on Toasted Marble Rye",
  },
  {
    id: 11,
    title: "B.L.T.A.P.",
  ...
  },
  {
    ...
    img: ShellsAndCheese,
    desc: "Homemade Cheese Sauce Served over Tender Shells\nExtra Cheese: 1.25 | Crumbled Bacon: 1.50 | Roasted Chicken: 4.00 | Red or Green Chili: 3.50 | Gulf Shrimp**: 5.00",
  },
  {
    id: 31,
    title: "Soups",
    ...
    price: "",
    img: Juices,
    desc: "Ask Our Servers About Our Delicious, Seasonal Soups!",
  },
  {
    id: 32,
