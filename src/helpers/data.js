...
export const menu = [
  ...
  },
  {
    ...
    price: 11.0,
    img: HuevosRancheros,
    desc: "A Grilled Flour Tortilla, Stuffed with Cheese & Smothered in Green Chili. Topped with 2 Eggs Any Stye\nAdd Sour Cream for 1.00",
  },
  {
    id: 7,
    ...
    img: GFPancakes,
    desc: "Homemade Gluten Free Pancakes\nAdd Fruit Topping for 1.50.",
  },
  {
    id: 8,
    ...
    desc: "2 Eggs Any Style on Your Choice of:\nToast | English Muffin | Biscuit | 2 Small Pancakes\nAmerican | Cheddar | Swiss | Smoked Gouda | Provolone\n2 Pieces of Bacon | 1 Sausage Patty | 1 Ham Steak\n With Homefries, Hashbrows, Or Seasonal Fruit on the Side",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    price: 12.0,
    img: FrenchDip,
    desc: "1/2 lb. of Our Slow Roasted, Thin Sliced Beef Topped with Sauteed Onions, Mushrooms & Smoked Gouda Served on a Homemade Hoagie Roll",
  },
  {
    id: 13,
  ...
  },
  {
    ...
    price: 12.0,
    img: SteakAndCheese,
    desc: "1/2 lb. of Our Slow Roasted, Thin Sliced Beef with Sauteed Peppers, Onions & Cheddar Sauce on a Homemade Hoagie Roll",
  },
  {
    id: 16,
    ...
    price: 11.0,
    img: Gobbler,
    desc: "Thin Sliced Roasted Turkey Breast, with Bacon, Candied Jalepeno Cranberry Sauce & Provolone on Our Homemade Bread",
  },
  {
    id: 17,
    title: "The Red Rock",
  ...
  },
  {
    ...
    img: Fajita,
    desc: "Romaine Lettuce Topped with Sauteed Peppers & Onions, Tomatoes, Black Olives, Avocado, Shredded Cheese & Sour Cream\nAdd an Additional Protien for 4.00",
  },
  {
    id: 29,
  ...
  //   price: 3.5,
  //   img: Coffee,
  //   desc: "Flavored Syrup Available Upon Request",
  // },
  // {
  //   id: 31,
  ...
  //   price: 22,
  //   img: Juices,
  //   desc: "Ask About OUr Seasonal Drinks!",
  // },
  // {
  //   id: 33,
  ...
  //   price: 3.0,
  //   img: Soda,
  //   desc: "Coke | Diet Coke | Sprite | Sweet Tea",
  // },
];
